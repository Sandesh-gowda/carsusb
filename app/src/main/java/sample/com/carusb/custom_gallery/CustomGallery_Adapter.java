...
import sample.com.carusb.utils.DisplayImage_Utils;

/**
 * Created by SONU on 26/12/15.
 */
public class CustomGallery_Adapter extends BaseAdapter {
    ...
    public CustomGallery_Adapter(Context context, ArrayList<String> imageUrls, boolean isCustomGalleryActivity) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null)
            view = inflater.inflate(R.layout.custom_gallery_layout, viewGroup, false);//Inflate layout
        ...
        if (imageUrls.get(position).startsWith("http://"))
            DisplayImage_Utils.displayBitmapImage(context,imageUrls.get(position),imageView);
        else
            DisplayImage_Utils.displayBitmapImage(context, "file://" +imageUrls.get(position), imageView);
    ...
    CompoundButton.OnCheckedChangeListener mCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            ((Gallery_Activity) context).showSelectButton();//call custom gallery activity method
        }
    };
}